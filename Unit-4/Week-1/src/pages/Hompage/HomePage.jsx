...
import bgImage from "../../Images/rm222batch4-mind-07.jpg";
...
const HomePage = () => {
    ...
    return (
        <div className="h-screen opacity-90 flex flex-col items-center justify-center space-y-6 " style={{ backgroundImage: `url(${bgImage})`, backgroundSize: "cover"}}>

            {/* Main Card Section with Glassmorphism */}
            <div className="backdrop-blur-md bg-white/30 h-auto md:h-[70%] w-11/12 md:w-3/4 lg:w-1/2 mt-24 rounded-xl shadow-lg border border-gray-200 p-6">
                <div className="flex flex-col space-y-6">
                    <div className='flex flex-col items-center justify-center w-full h-full'>
                        <img src={UserLogo} alt="user" className='w-4/12 h-6/12 md:w-4/12 md:h-4/12 rounded-full m-auto' />
                    ...
                    <div className='border-gray-300 border-spacing-2'>
                        <div className="text-xl space-y-6 p-6">
                            <p className="flex justify-between text-start"><strong>Date:</strong>{dayjs(profile?.created_on).format("D MMM, YYYY h:mm A")}</p>
            ...
            <div className='flex flex-col sm:flex-row justify-center sm:justify-around mx-auto w-full gap-4'>
                {/* Add Amount Button */}
                <button onClick={openAmountModal} className='bg-green-500 text-white py-5 w-full sm:w-[45%] text-xl rounded-lg'>
                    Add Amount
                </button>

                {/* Add Penalty Button */}
                <button onClick={openPenaltyModal} className='bg-red-500 text-white py-5 w-full sm:w-[45%] text-xl rounded-lg'>
                    Add Penalty
                </button>
            </div>
            </div>
